...
export const COMPONENTS_ALL_PATTERN = 'Resource/{Parts,RawResources,Equipment}/**/{Desc,BP}_*.json'

export const COMPONENTS_DESCS_PATTERN = 'Resource/**/Desc_*.json'

export const BUILDABLE_MAIN_PATTERN_BASE = 'Buildable/Factory/**'

export const BUILDABLE_DESC_PATTERN = `${BUILDABLE_MAIN_PATTERN_BASE}/Desc_*.json`

export const BUILDABLE_RECIPE_PATTERN = 'Recipes/Buildings/**/Recipe_*.json'
